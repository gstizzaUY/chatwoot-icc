...
const CAMPAIGN_KEY = 'ichef_taller_blw';
...
const TEMPLATE_NAME = 'ichef_taller_blw';
const TEMPLATE_VARIABLES = [
    {
        header_image:
            'https://img.auctiva.com/imgdata/1/5/5/1/4/3/4/webimg/1179577446_o.png'
    }
];
...
// ============================================================
const ichefTallerBlw = async (req, res) => {
